      ...
      <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <input type="hidden" name="old_photo" value="<?= $data->foto_perbaikan ?>" class="form-control" id="inputEmail3" required>
              <input type="hidden" name="id" value="<?= $data->id_pemeliharaan?> ">
          </div>
          </div>
